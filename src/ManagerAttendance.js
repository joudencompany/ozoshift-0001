  ...
  <div style={{ marginBottom: '1rem', paddingBottom: '1rem', borderBottom: '1px dashed #E0E0E0' }}>
    ...
    <div style={{
      ...
      <div style={{ textAlign: 'center' }}>
        ...
        <div style={{ fontSize: '1.1rem', fontWeight: 'bold', textDecoration: selectedExpense.previous?.transport_fee !== selectedExpense.transport_fee ? 'line-through' : 'none', color: '#888' }}>
